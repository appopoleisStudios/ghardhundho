...
<div class="comments-area">
    ...
    <div class="comment-box">
        ...
        <div class="comment">
            ...
            <img src="{{ (!empty($com->user->photo)) ? url('upload/user_images/'.$com->user->photo) : url('upload/no_image.jpg') }}" alt="">            </figure>
            <div class="comment-inner">
                ...
                <div class="text">
                    <p>{{ $com->subject  }}</p>
                    <p>{{ $com->message  }}</p>
                    <a href="{{route('admin.comment.reply',$com->id)}}"><i class="fas fa-share"></i>Reply</a>
                </div>
            </div>
        </div>
@php
    ...
    <div class="widget-content">
        <ul class="category-list clearfix">
           ...
           @endphp
            ...
            <li><a href="{{ url('blog/cat/list/'.$cat->id) }}">{{ $cat->category_name }}<span>({{ count($post) }})</span></a></li>            @endforeach
        </ul>
    </div>
</div>
